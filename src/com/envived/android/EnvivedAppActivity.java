...
public class EnvivedAppActivity extends Activity implements OnClickListener {
	private static final String TAG = "EnvivedAppActivity";
    ...
    protected void onRestart() {
    	super.onRestart();
    	//Log.d(TAG, "--- onRestart in EnvivedAppActivity !!!!!!!!!!!!!!");
    ...
    private class CheckoutTask extends AsyncTask<Void, Void, ResponseHolder> {
		...
		protected void onPreExecute() {
			mLoadingDialog = ProgressDialog.show(EnvivedAppActivity.this, 
					"", "Checking out ...", true);
		}
    ...
    private class CreateDeleteAnonymousTask extends AsyncTask<Integer, Void, ResponseHolder> {
		...
		@Override
		protected void onPreExecute() {
			mLoadingDialog = new ProgressDialog(new ContextThemeWrapper(EnvivedAppActivity.this, R.style.ProgressDialogWhiteText));
		...
		protected void onPostExecute(ResponseHolder holder) {
			...
			if (holder.hasError()) {
				...
				if (holder.getCode() != HttpStatus.SC_OK) {
					...
					startActivity(new Intent(EnvivedAppActivity.this, HomeActivity.class));
				}
			}
